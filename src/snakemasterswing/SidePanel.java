...
public class SidePanel extends JPanel {
     ...
     */
    public SidePanel(SnakeGameMain game) {
        this.game = game;
    ...
    public void paintComponent(Graphics g) {
        ...
        g.drawString("Khelo Beta ", getWidth() / 2 - g.getFontMetrics().stringWidth("Khelo Beta ") / 2, 20);
